...
static GOptionEntry remmina_options[] = {
	...
	{"full-version", 'V', 0, G_OPTION_ARG_NONE, NULL, N_("Show the application's version, including plugins"), NULL},
	{NULL}
};
...
static void remmina_on_startup(GApplication * app)
{
	...
	gtk_icon_theme_append_search_path(gtk_icon_theme_get_default(), REMMINA_DATADIR G_DIR_SEPARATOR_S "icons");
